    ...
    const principles = [
        {
            ...
            Nihil suscipit cupiditate expedita hic earum vero sint, recusandae itaque, rem distinctio.`
        },
        {
            id: 2,
            text: `Totam porro sit, obcaecati quos quae iure tenetur,
             soluta voluptatem sapiente rerum ipsam delectus corporis voluptates voluptate, nulla mollitia pariatur.`
        },
        {
            id: 3,
            text: (
        ...
        },
        {
            id: 4,
            text: `Lorem ipsum dolor sit amet, consectetur adipisicing elit.
             Nihil suscipit cupiditate expedita hic earum vero sint, recusandae 
             itaque, rem distinctio.`
        },
    ];

    const knowUsParagraphs = [
        `Fugit recusandae dolores, hic suscipit necessitatibus nobis culpa,
          quidem inventore molestias autem eligendi provident, natus eius reprehenderit
          repudiandae velit! Aut qui deleniti autem nobis laborum sapiente tempore, 
          facere cumque tempora laudantium porro illo officiis culpa labore magnam itaque 
          eos quia asperiores officia voluptas voluptatem est molestias architecto magni corporis. 
          Cupiditate, voluptates, saepe.`,
        ...
        `Nulla delectus tempora ab ipsum molestias dolorem explicabo nihil. 
         ...
         qui dolore voluptatibus eos quisquam obcaecati, omnis iste illum optio. 
         Maxime atque hic vero. Doloribus eius sit laborum fugiat necessitatibus 
         tempora facilis facere cumque, ipsum nam, temporibus, perferendis non ratione!`
    ];
        ...
        <div className="about-container">
            ...
            <div className="content">
                ...
                <div className="right">
                    ...
                    {knowUsParagraphs.map((text, index) => (
